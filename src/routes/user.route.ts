...
import { changeUserPasswordHandle, deleteUserFriendRequestHandle, deleteUserHandle, getAllUserHandle, getNearbyUserFriendsHandle, getUserByUsnHandle, getUserFriendsHandle, getUserHandle, loginUserHandle, postUserHandler, requestFriendHandle, updateFriendRequestStatusHandle, updateUserHandle, verifyUserTokenHandle } from "../controllers/user.controller";
...
router.get("/nearby/", getNearbyUserFriendsHandle);
